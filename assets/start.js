    ...
    },
    {
      ...
      sections: [
        ...
        ['速记、日历、专注与复习', '删除哪一项，就会清空对应页面的数据。', [
          ...
          ['<code>ledger.json</code>', '日历“记账”视图中的全部人民币收支流水，包括金额、日期、备注和颜色。删除后记账页会从空白开始，不影响日记、每日任务或其它日历数据。'],
    ...
    },
    {
      ...
      sections: [
        ...
        ['Quick notes, Calendar, Focus, and Review', 'Deleting an item clears the data for its corresponding page.', [
          ...
          ['<code>ledger.json</code>', 'All RMB income and expense entries from Calendar’s Ledger view, including amounts, dates, notes, and colors. Deleting it starts Ledger from empty without affecting journals, daily tasks, or other Calendar data.'],
