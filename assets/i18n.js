(function () {
  ...
  const EN = {
    ...
    '速记墙可以像画布一样平移、缩放和惯性滑行。鼠标靠近速记页右缘会浮现控制台入口，其中的「拖拽惯性」同时控制便签与整面墙的滑行强度。': 'Pan, zoom, and glide across Quick Notes like a canvas. Move the pointer near the right edge to reveal its controls; Drag inertia affects both notes and the whole wall.',
    '右缘控制台': 'Right-edge controls', '选择随机生成颜色、调整手感、总览或重置视野。': 'Choose generated colors, tune the feel, fit notes, or reset the view.',
