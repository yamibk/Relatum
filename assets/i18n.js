(function () {
  ...
  const EN = {
    ...
    '笔记': 'Notes', '博客': 'Blog', '工作区': 'Workspace', 'Markdown 笔记库': 'Markdown notes library',
    ...
    '链接到的笔记': 'Outgoing links', '反向链接': 'Backlinks', '复制内容': 'Copy content', '恢复此版本': 'Restore version', '博客工作区': 'Blog workspace',
    '这里已经成为独立工作区入口。下一轮会在笔记库稳定后接入静态博客与发布联动。': 'This is now an independent workspace. Static blog publishing will connect after the notes library is stable.',
    '先整理笔记': 'Organize notes first',
    ...
    '删除前先看': 'Before deleting', 'canvases 与 notes': 'canvases and notes', 'data 文件夹': 'data folder',
