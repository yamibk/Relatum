(function () {
  ...
  const EN = {
    ...
    '隐藏高级创建入口，已有路线与解锁关系不受影响': 'Hide advanced creation controls without changing existing routes or unlock relationships.',
...
'把任务长度拆成有名字的任务点。达成状态会根据当前进度自动点亮。': 'Break the target into named milestones. Status lights up automatically as you progress.',
    ...
    '如需新建后续阶段或添加条件，请在起步页齿轮中关闭“精简目标树编辑”；这不会修改已有路线。': 'To create following stages or add conditions, turn off Simplify Goal Tree editing in Home settings. Existing routes are not changed.',
